...
{
    if (Code<0x80) *dest++=Code;
    else if (Code<0x800) *dest++=192+Code/64, *dest++=128+Code%64;
    else if (Code-0xd800u<0x800) *dest = 0;
    else if (Code<0x10000) *dest++=224+Code/4096, *dest++=128+Code/64%64, *dest++=128+Code%64;
    else if (Code<0x110000) *dest++=240+Code/262144, *dest++=128+Code/4096%64, *dest++=128+Code/64%64, *dest++=128+Code%64;
    else *dest=0;
    *dest = 0;
}
