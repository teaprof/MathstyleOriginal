...
class THTMLWriter : public TRectangleElementVisitor
{
    ...
    public:
        ...
        void AddParagraph(std::string str, void* R); // %N для формулы на отдельной строке, %n - для inline-формулы; также можно использовать %d
        ...
        void AddParagraph(std::string str, const TNumeric& N); // %N для формулы на отдельной строке, %n - для inline-формулы; также можно использовать %d
