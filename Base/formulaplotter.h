...
class TFormulaPlotter
{
    ...
    Metrics IntervalGetTextRectangle(std::shared_ptr<TNumeric> N, bool WithBrackets, bool Simplify) const; //for OperatorInterval, OperatorSegmentInterval, OperatorIntervalSegment, OperatorSegment
