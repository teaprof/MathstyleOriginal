...
// для реализации c QT
{
  public:
    ...
    int SetTextHPlusD(string Text,
                      int H,
                      int D);  // методом половинного деления устанавливает шрифт, чтобы у него высота плюс глубина была бы равна
                               // H + D возвращает смещение базовой линии, с которой нужно рисовать Text
...
class TLine :
    public TRectangleElement,
    public vector<TRectangleElement*>
